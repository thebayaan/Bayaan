...
VALUES (
  ...
  'Hafs A''n Asim',
  'Murattal',
  'https://redacted.supabase.co/storage/v1/object/public/quran-audio/reciters/{folder}',
  114,
  '1,2,3,...,114',
  'supabase'
);
...
```sql
UPDATE rewayat SET
  server = 'https://redacted.supabase.co/storage/v1/object/public/quran-audio/reciters/{folder}',
  surah_total = 114,
...
for file in *.mp3; do
  curl -X POST "https://redacted.supabase.co/storage/v1/object/quran-audio/reciters/{folder}/$file" \
...
```bash
curl -s "https://redacted.supabase.co/storage/v1/object/list/quran-audio" \
...
| Supabase | `https://redacted.supabase.co/storage/v1/object/public/quran-audio/reciters/{folder}/{surah}.mp3` |
