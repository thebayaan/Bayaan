...
//     // No-op the toggle function - intentionally empty for cleanup
//     // eslint-disable-next-line @typescript-eslint/no-empty-function
//     playerStore.toggleFavoriteTrack = () => {};

//     // @ts-expect-error - We know this exists from the store type, but it's being cleaned up
