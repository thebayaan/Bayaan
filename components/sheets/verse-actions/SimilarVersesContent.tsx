  ...
  if (loading) {
    return (
      <ActivityIndicator
        ...
        style={{marginVertical: verticalScale(40)}}
      />
    );
  }
  ...
  return (
    <ScrollView
            ...
            return (
              <View key={phrase.phraseId} style={styles.phraseCard}>
                ...
                {(expandedPhrases.has(phrase.phraseId)
                  ...
                  const isVerseExpanded = expandedVerses.has(match.verseKey);
                  return (
                    <View key={match.verseKey}>
                      <Pressable
                        ...
                        <Feather
                          name={isVerseExpanded ? 'chevron-up' : 'chevron-down'}
                      ...
                      {isVerseExpanded && (
                        <View style={styles.matchExpanded}>
                          ...
                          <Pressable
                            ...
                            onPress={() => handleVersePress(match.verseKey)}>
      ...
      {similarAyahs.length > 0 && (
        <View style={styles.section}>
          <Text style={styles.sectionLabel}>SIMILAR WORDING</Text>

          {(showAllSimilar ? similarAyahs : similarAyahs.slice(0, 20)).map(
            similar => {
...
const createStyles = (theme: Theme) =>
  ScaledSheet.create({
    ...
    matchExpanded: {
      ...
      borderTopWidth: 1,
      borderTopColor: Color(theme.colors.text).alpha(0.05).toString(),
